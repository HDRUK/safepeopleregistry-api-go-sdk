...
// checks if the CustodianGetOrganisations200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustodianGetOrganisations200ResponseData{}

// CustodianGetOrganisations200ResponseData struct for CustodianGetOrganisations200ResponseData
type CustodianGetOrganisations200ResponseData struct {
...
func NewCustodianGetOrganisations200ResponseData() *CustodianGetOrganisations200ResponseData {
	this := CustodianGetOrganisations200ResponseData{}
	return &this
}
...
func (o CustodianGetOrganisations200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o CustodianGetOrganisations200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableCustodianGetOrganisations200ResponseData struct {
	value *CustodianGetOrganisations200ResponseData
	isSet bool
}

func (v NullableCustodianGetOrganisations200ResponseData) Get() *CustodianGetOrganisations200ResponseData {
	return v.value
}

func (v *NullableCustodianGetOrganisations200ResponseData) Set(val *CustodianGetOrganisations200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCustodianGetOrganisations200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCustodianGetOrganisations200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustodianGetOrganisations200ResponseData(val *CustodianGetOrganisations200ResponseData) *NullableCustodianGetOrganisations200ResponseData {
	return &NullableCustodianGetOrganisations200ResponseData{value: val, isSet: true}
}

func (v NullableCustodianGetOrganisations200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustodianGetOrganisations200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
