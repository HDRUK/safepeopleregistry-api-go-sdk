...
// checks if the OrganisationGetUsers200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganisationGetUsers200ResponseData{}

// OrganisationGetUsers200ResponseData struct for OrganisationGetUsers200ResponseData
type OrganisationGetUsers200ResponseData struct {
	CurrentPage *int32 `json:"current_page,omitempty"`
	Data []OrganisationGetUsers200ResponseDataDataInner `json:"data,omitempty"`
...
func NewOrganisationGetUsers200ResponseData() *OrganisationGetUsers200ResponseData {
	this := OrganisationGetUsers200ResponseData{}
	return &this
}
...
func (o *OrganisationGetUsers200ResponseData) GetData() []OrganisationGetUsers200ResponseDataDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []OrganisationGetUsers200ResponseDataDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []OrganisationGetUsers200ResponseDataDataInner and assigns it to the Data field.
...
func (o OrganisationGetUsers200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o OrganisationGetUsers200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableOrganisationGetUsers200ResponseData struct {
	value *OrganisationGetUsers200ResponseData
	isSet bool
}

func (v NullableOrganisationGetUsers200ResponseData) Get() *OrganisationGetUsers200ResponseData {
	return v.value
}

func (v *NullableOrganisationGetUsers200ResponseData) Set(val *OrganisationGetUsers200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganisationGetUsers200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganisationGetUsers200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganisationGetUsers200ResponseData(val *OrganisationGetUsers200ResponseData) *NullableOrganisationGetUsers200ResponseData {
	return &NullableOrganisationGetUsers200ResponseData{value: val, isSet: true}
}

func (v NullableOrganisationGetUsers200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganisationGetUsers200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
